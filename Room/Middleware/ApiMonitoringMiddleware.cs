...
using Room.Data;//använd era bibliotek här 

using Room.Models;//använd era bibliotek här 
...

{
    ...
    public async Task Invoke(HttpContext context, RoomDbContext dbContext)
